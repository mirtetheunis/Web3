        ...
        <nav>
            <ul>
                ...
                <c:if test="${user.role=='ADMIN' || user.role=='CUSTOMER'}">
                    ...
                    <li id="actual"><a href="Controller?command=OPEN_registertest">Register Test</a> </li>
    ...
    <main>
        ...
        <form method="POST" action="Controller?command=RegisterTest" novalidate="novalidate">
            ...
            <p><label for="dateTest">Date</label>
                <input type="text" id="dateTest" name="dateTest" required pattern ="[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])"> </p>
